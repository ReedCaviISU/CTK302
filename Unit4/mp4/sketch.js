...
var z = 0;
 ...
 function preload() {
   song1 = loadSound("assets/themesong.mp3");
 }
...
function setup() {
  ...
  landImage = loadImage("assets/landscape.jpg");
  jurassicImage = loadImage("assets/dinosaur.jpg");
...
function draw() {
  ...
  //image(dinoImage, 50, 50, 200, 200);
  image(landImage, 500, 500, 800, 800);
  image(jurassicImage, 500, 100, 800, 100);
  // rect(0, 0, 100, 100) ;
  pop();
...
for (var i = 0; i < cars.length; i++) {
  ...
  // Text that makes CTK type in the background
   ...
   textSize(10);
   textAlign(CENTER);
   text("DINOSAUR'S\nHAVE RETURNED!", width / 2, height / 3);
